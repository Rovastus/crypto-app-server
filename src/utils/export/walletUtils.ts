...
export const getRecordFromWallet = function getRecordFromWallet(
  ...
  const record: Array<PrismaTypes.Prisma.WalletCreateWithoutPortpholioInput> =
    wallet.filter((obj) => obj.coin === coin)
...
export const updateWalletRecordByTakingCoin =
  function updateWalletRecordByTakingCoin(
...
export const updateWalletRecordByAddingCoin =
  function updateWalletRecordByAddingCoin(
    record: PrismaTypes.Prisma.WalletCreateWithoutPortpholioInput,
    amountToAdd: Decimal,
    totalToAdd: Decimal,
    time: Date,
